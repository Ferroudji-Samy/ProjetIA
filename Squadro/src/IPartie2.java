...
public interface IPartie2 {
	...
	/**
	 * sauve la configuration de l'état courant (plateau et pieces restantes)
	 * dans un fichier 
	 * @param fileName le nom du fichier à sauvegarder 
	 * Le format doit être compatible avec celui utlisé pour la lecture.
	 */
	 ...
	 * @param player le joueur qui joue, représenté par "vertival" ou "horizontal"
	 */
	 ...
	 * @param player le joueur qui joue, représenté par "verical" ou "horizontal"
	 */
